...
import { ArrowLeft, Calendar, Share2, Twitter, Linkedin, Bot, Sparkles } from 'lucide-react'
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return {
    title: `${post.title} - AI Trading Arena Blog`,
      ...
      <main className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <header className="mb-8">
          <div className="flex items-center gap-3 mb-4 flex-wrap">
            ...
            {post.ai_generated && (
              <span className="text-sm px-3 py-1 rounded-full font-medium bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300 flex items-center gap-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="font-medium text-sm">
                  {post.ai_model ? `${post.ai_model}` : 'AI Trading Arena'}
                </p>
                <p className="text-xs text-gray-500">Automated Content</p>
              </div>
            </div>
          </div>
        </header>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm">
                ...
                <p className="text-purple-600 dark:text-purple-400 mt-1">
                  This post was automatically generated by {post.ai_model || 'Claude Opus'}.
                  Content is created based on real market data and current events.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 bg-white dark:bg-gray-800 rounded-xl p-6 text-center">
          <h3 className="font-semibold mb-2">Want more AI-powered insights?</h3>
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            New posts are generated automatically twice daily at 9AM and 9PM.
          </p>
          <Link
            href="/blog"
